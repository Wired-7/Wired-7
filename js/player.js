const LainPlayer = (() => {
    ...
    function changeSource(source) {
        ...
        if(audioTag.currentSrc.endsWith("ogg")) {
            audioTag.src = "https://lainon.life/radio/" + source + ".ogg";
        } else {
            audioTag.src = "https://lainon.life/radio/" + source + ".mp3";
        }
    ...
    function cycleVolume() {
        if (audioTag.volume < 0.25) {
            audioTag.volume = 0.25;
        } else if (audioTag.volume < 0.50) {
            audioTag.volume = 0.50;
        } else if (audioTag.volume < 0.75) {
            audioTag.volume = 0.75;
